...
**覆蓋率**：15 款底版上蓋有配置數據（配色／金屬塗層版共用，即 279 張上蓋卡入面 44 張）、固鎖 12 件、軸心 13 件。其餘冇公開紀錄，一律留白。

日本社群 12 選入面兩個譯名對照，由 Brian 確認：`Dran Strike` = 蒼龍突擊（Dran Blitz）、`Night Lance` = 騎士長槍（Knight Lance）。仍未對到嘅係 `Leon Crest 7-60 N`，未入。
